                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo h3 mb-0 fw-bold">FashionHut Admin</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to FashionHut Admin</h4>
                        <!-- <p class="mb-4">Please sign-in to your account and start the adventure</p> -->
                         <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                <!-- <a  class="btn btn-primary d-grid w-100">Sign in</a> -->
